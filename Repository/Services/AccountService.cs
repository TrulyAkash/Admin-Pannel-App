...
namespace AdminPannelApp.Repository.Services
{
    public class AccountService : IUsers
    {
        ...
        private void SendMail(string to, string Otp)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("akashsengar55@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("akashsengar55@gmail.com", "itsGMAIL007@"); // Enter seders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
        }
